  ...
  return (
    <div className="fixed top-0 left-0 h-full w-64 bg-emerald-600 flex flex-col z-20 shadow-2xl">
      ...
      <div className="p-4 border-b border-white/10 text-black">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <a
              href="/admin/profile"
              className="text-xs text-black-300 hover:text-indigo-100 transition-colors"
            >
              View profile
            </a>
          </div>
        ...
        {navigation
          ...
          .map((item) => (
            ...
            >
              <item.icon
                className={classNames(
                  item.current ? "text-white" : "text-black/90",
                  "mr-3 h-5 w-5"
                )}
                aria-hidden="true"
              />
      ...
      <div className="mt-auto p-4">
        <SignOutButton>
          <div className="flex items-center justify-center w-full px-4 py-3 bg-red-950 text-white font-semibold text-lg rounded-lg shadow-xl hover:bg-red-700 transition-colors duration-150">
