        ...
        <div className="min-h-screen bg-gray-50 font-sans">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 lg:py-24">
                ...
                <div className="text-center mb-16 lg:mb-24">
                    <p className="text-lg/6 font-semibold text-red-900 tracking-wide uppercase">Our Commitment to Excellence</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {serviceOfferings.map((service) => (
                        ...
                        >
                            <div className={`p-3 inline-flex items-center justify-center h-12 w-12 rounded-full bg-black/8 mb-4`}>
                                <service.icon className={`h-6 w-6 ${service.color}`} aria-hidden="true" />
                            </div>
                            <h2 className="text-xl font-bold text-black/95 mb-3">{service.name}</h2>
