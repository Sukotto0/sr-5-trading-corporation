            ...
            <Card className="overflow-hidden py-0">
              <CardContent className="p-0">
                <div className="aspect-square relative overflow-hidden group bg-muted">
                  {!(selectedImage || product.imageUrl) || failedImages.has(selectedImage || product.imageUrl) ? (
                    ...
                    <Image
                      ...
                      priority
                      onError={() => {
                        setFailedImages(prev => new Set(prev).add(selectedImage || product.imageUrl));
                      }}
                    />
                  )}
              ...
              <div className="flex gap-2 overflow-x-auto pb-2">
                {product.images.map((img, index) => (
                  <button
                    ...
                    className={`relative w-20 h-20 shrink-0 rounded-md overflow-hidden border-2 transition-all bg-muted ${
